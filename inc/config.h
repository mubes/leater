...
#define LEATER_PROFILES {	.name="Oven Reflow - Leaded\0\0",									\
...
#define LEATER_CONFIG   .version=LEATER_VERSION_NUMBER, \
						.logOutputCSV=TRUE,             \
						.setPoint=13*DEGREE, 			\
						.recordInterval=20,				\
						.k=3,							\
...
typedef enum { 	CONFIG_ITEM_version, CONFIG_ITEM_logOutputCSV, CONFIG_ITEM_setPoint,
				...
				CONFIG_ITEM_defaults, CONFIG_ITEM_reload, CONFIG_ITEM_help, CONFIG_ITEM_end } config_item_enum;
