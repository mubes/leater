...
void pidSetManualOutput(pidInstanceType *p,
                        int32_t outputSet); // Set manual output level (for open loop working)
void pidSetOutputAuto(pidInstanceType *p,
                      BOOL automaticSet);    // Set manual or automatic output (open or closed loop)
BOOL pidIsClosedloop(pidInstanceType
                     *p);               // Return flag indicating if in closed loop mode
