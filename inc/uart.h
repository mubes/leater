...
void uartEvent(void);						// A character received in the interrupt level handled in the base level
...
void uartUnlockbuffer(void);			    // Unlock buffer and make it available for input characters
