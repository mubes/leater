...
{
    pidSetParams(&pidInstance, sysConfig.Cp, sysConfig.Ci, sysConfig.Cd, CYCLE_LEN, 0, CYCLE_LEN/25,
                 CYCLE_LEN, 0);
}
// ============================================================================================
void stateInit(void)
...
{
    statePIDSet();
    pidSetSetpoint(&pidInstance,
                   SETPOINT_IDLE);     // Unless we're told differently, then don't try and perform any heating
